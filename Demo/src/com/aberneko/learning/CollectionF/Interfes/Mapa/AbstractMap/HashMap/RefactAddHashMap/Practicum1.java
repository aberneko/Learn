package com.aberneko.learning.CollectionF.Interfes.Mapa.AbstractMap.HashMap.RefactAddHashMap;
...
public class Practicum1 {
    public static void main(String[] args) {
        ...
        Converter1 converter = new Converter1(94.8,103.8,13.1);
        DinnerAdvisor1 dinnerAdvisor = new DinnerAdvisor1();
        ExpensesManager1 expensesManager = new ExpensesManager1();
        ...
        while (true) {
            ...
            if (command == 1) {
                ...
                expensesManager.getExpensesSum();
            } else if (command == 8) {
                String category = scanner.next();
